...
/***/ function(module, exports, __webpack_require__) {
	...
	var _history = __webpack_require__(114);
	...
	var Home = exports.Home = _react2.default.createClass({
		...
		openLoginWindow: function openLoginWindow(event) {
			if (!this.props.token) {
				...
				(0, _history.goToCurrentStep)(this.props.state);
			}
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FakePage = __webpack_require__(88);

	var _Bash = __webpack_require__(80);

	var _CopyButton = __webpack_require__(67);
	...
	var _Troubleshooting = __webpack_require__(93);
	...
	var Troubleshooting = _react2.default.createClass({
		...
		render: function render() {
			var isOpen = this.props.troubleshootingKey === this.props.key;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h4',
					{ className: _Troubleshooting2.default.help },
					'Help! I got an error!'
				),
				this.props.children
			);
	...
	function mapDispatchToProps(dispatch) {
		return {
			open: function open(key) {
				return dispatch((0, _actionCreators.openTroubleshooting)(key));
			}
		};
	}
	...
	Troubleshooting = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Troubleshooting);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						'. You won\'t be able to copy and paste them - that\'s so you get some practice with typing in the terminal on your own.'
					),
					_react2.default.createElement(
						'p',
						null,
						'Here\'s the first command to type. It takes you to your code folder, where you\'ll put your first HTML file:'
					),
					_react2.default.createElement(
						_Bash.Bash,
						{ noSelect: true },
					...
					_react2.default.createElement(
						'p',
						null,
						'This next command creates a new file called "',
						fileName,
						'":'
					),
					_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						' ',
						'into your file in Sublime Text. Press ',
						_react2.default.createElement(
							_Keyboard.Key,
							null,
							'Command'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.goToCurrentStep = goToCurrentStep;
	...
	function goToCurrentStep(state) {
		getInitialLocation().then(function (location) {
			if (typeof state.user.get('currentStep') !== 'undefined' && location.pathname === '/') {
				var currentStep = state.user.get('currentStep');
				var step = state.db.getIn(['steps', currentStep.toString()]);
				var route = '/step/' + step.get('branchName');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDOMHistory = __webpack_require__(138);

	var _createDOMHistory2 = _interopRequireDefault(_createDOMHistory);

	var _parsePath = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHistory = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(144);
